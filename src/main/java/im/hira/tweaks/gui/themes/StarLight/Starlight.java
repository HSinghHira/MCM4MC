package im.hira.tweaks.gui.themes.StarLight;

import im.hira.tweaks.gui.themes.StarLight.widgets.*;
import im.hira.tweaks.gui.themes.StarLight.widgets.input.WMeteorDropdown;
import im.hira.tweaks.gui.themes.StarLight.widgets.input.WMeteorSlider;
import im.hira.tweaks.gui.themes.StarLight.widgets.input.WMeteorTextBox;

import im.hira.tweaks.gui.themes.StarLight.widgets.pressable.*;
...
public class Starlight extends GuiTheme {

    public Starlight() {super("Starlight");settingsFactory = new DefaultSettingsWidgetFactory(this);}
    ...
    public final Setting<SettingColor> accentColor = color("accent", "Main color of the GUI.", new SettingColor(9, 3, 15));
    public final Setting<SettingColor> checkboxColor = color("checkbox", "Color of checkbox.", new SettingColor(9, 3, 15));
    ...
    public WConfirmedButton confirmedButton(String text, String confirmText, GuiTexture texture) {
        return w(new WConfirmMeteorButton(text, confirmText));
    }

    @Override
    public WConfirmedMinus confirmedMinus() {
        return w(new WConfirmMeteorMinus());
    }
