package im.hira.tweaks.modules.Movements;

import im.hira.tweaks.MCM4MC;
import im.hira.tweaks.Utils;
...
public class AFKVanillaFly extends Module {
    ...
    public AFKVanillaFly() {
        super(MCM4MC.JH_MOVEMENT_CAT, "AFKVanillaFly", "Maintains a level Y-flight with fireworks and smooth pitch control.");
    }
