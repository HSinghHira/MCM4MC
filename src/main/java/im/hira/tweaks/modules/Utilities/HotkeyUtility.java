...
import im.hira.tweaks.gui.screens.HotkeysScreen;
import im.hira.tweaks.util.Hotkey;
...
public class HotkeyUtility extends Module {
    ...
    public HotkeyUtility() {
        super(MCM4MC.JH_UTILITIES_CAT, "hotkey-utility", "Allows you to set key combinations to switch to a specific hotbar slot.");
        loadHotkeys();
    }
    ...
    private File getHotkeysFile() {
        File folder = new File(MeteorClient.FOLDER, "jatthira");
