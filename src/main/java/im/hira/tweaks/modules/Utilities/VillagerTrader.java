...
public class VillagerTrader extends Module {
    ...
    public VillagerTrader() {
        super(MCM4MC.JH_UTILITIES_CAT, "Villager Trader (Beta)", "Speeds up villager trading.");
    }
    ...
    private final Setting<Set<EntityType<?>>> entities = sgGeneral.add(new EntityTypeListSetting.Builder()
        .name("just-tick-villager")
        .description("Entities to trade with.")
        .build());
            ...
            BlockIterator.after(() -> {
                ...
                for (var block : blocks) {
                    ...
                    if (mc.interactionManager != null) {
                        mc.interactionManager.interactBlock(mc.player, Hand.MAIN_HAND, new BlockHitResult(new Vec3d(block.getX() + 0.5, block.getY() + 0.5, block.getZ() + 0.5), Direction.UP, block, false));
